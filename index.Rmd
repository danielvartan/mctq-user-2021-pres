...
.pull-left[
Temporal objects comes with more levels of abstraction.

* Time is not metrical
* Time data can assume many formats
* Time is cyclical
* Time is relational (itself does not exist)

See also: [Why Don't We Have Metric Time? | Answers With Joe](https://youtu.be/kUIYI34CdkE).
]
...
* `mctq` is currently under a [rOpenSci peer review](https://github.com/ropensci/software-review/issues/434). We plan to submit it to CRAN soon after the review process ends.
